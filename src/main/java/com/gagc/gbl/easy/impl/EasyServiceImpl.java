...
public class EasyServiceImpl implements IEasyService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.gagc.gbl.easy.itf.IEasyService#printExcel(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	public void printExcel(String path1, String path2) {
		...
		List<Object> list = EasyExcel.read(path2, ToStoreIndexData.class, new ToStoreDataLIstener()).sheet("物流信息表")
				.doReadSync();
		list.remove(0);
		list.remove(0);
