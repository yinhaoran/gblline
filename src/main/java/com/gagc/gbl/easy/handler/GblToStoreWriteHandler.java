...
public class GblToStoreWriteHandler implements CellWriteHandler {
    ...
    private static final int FIRST = 15;
    private static final int SECOND = 16;
    private static final int THIRD = 17;
    private static final int FOURTH = 18;
     ...
     *      com.alibaba.excel.write.metadata.holder.WriteTableHolder, org.apache.poi.ss.usermodel.Row,
     *      com.alibaba.excel.metadata.Head, java.lang.Integer, java.lang.Integer, java.lang.Boolean)
     */
    @Override
     ...
     *      com.alibaba.excel.write.metadata.holder.WriteTableHolder, org.apache.poi.ss.usermodel.Cell,
     ...
     *      com.alibaba.excel.write.metadata.holder.WriteTableHolder, java.util.List, org.apache.poi.ss.usermodel.Cell,
     *      com.alibaba.excel.metadata.Head, java.lang.Integer, java.lang.Boolean)
     */
    @Override
    public void afterCellDispose(WriteSheetHolder writeSheetHolder, WriteTableHolder writeTableHolder,
        List<CellData> cellDataList, Cell cell, Head head, Integer relativeRowIndex, Boolean isHead) {
        if (!isHead && (cell.getColumnIndex() == FIRST || cell.getColumnIndex() == SECOND
            || cell.getColumnIndex() == THIRD || cell.getColumnIndex() == FOURTH)) {
